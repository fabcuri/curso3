package br.com.treinamento.curso3.security;
...
public class MD5Cryptography {
	...
	// método estático anônimo para inicializar o atributo MessageD:
	static {
		try {
	...
	// método para converter um valor criptografado de byte [] para hexadecimal.
